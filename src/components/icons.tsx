...
export function LotusIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 2c3.333 3.333 5 5 5 10a5 5 0 11-10 0c0-5 1.667-6.667 5-10z"/>
      <path d="M2 12h5m10 0h5"/>
      <path d="M4.929 4.929l3.535 3.535M15.536 15.536l3.535 3.535"/>
      <path d="M4.929 19.071l3.535-3.535M15.536 8.464l3.535-3.535"/>
